...
export default function Create() {
  ...
  const pickImage = async () => {
    try {
      ...
      const result = await ImagePicker.launchImageLibraryAsync({
        ...
        aspect: [4, 3],
        quality: 0.5,
        base64: true, // ✅ required for upload
      });
      ...
      if (!result.canceled) {
        ...
        // ✅ Always get base64 (fallback to FileSystem if missing)
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // ✅ Convert base64 into proper Data URL for Cloudinary
      ...
      // ✅ Handle server responses safely
      let data;
      try {
